/* @ts-self-types="./jqf_wasm.d.ts" */

/**
 * The ABI version as a number, for the JS wrapper's load-time check.
 * @returns {number}
 */
export function jqf_abi_version() {
    const ret = wasm.jqf_abi_version();
    return ret >>> 0;
}
 ...
 * @returns {string}
 */
export function jqf_formats() {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.jqf_formats(retptr);
 ...
 * @returns {string}
 */
export function jqf_run(program, input, input_format, output_format, indent, flags, slurp) {
    let deferred5_0;
    let deferred5_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(program, wasm.__wbindgen_export3, wasm.__wbindgen_export4);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(input, wasm.__wbindgen_export3);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(input_format, wasm.__wbindgen_export3, wasm.__wbindgen_export4);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(output_format, wasm.__wbindgen_export3, wasm.__wbindgen_export4);
        const len3 = WASM_VECTOR_LEN;
        wasm.jqf_run(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, indent, flags, slurp);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred5_0 = r0;
        deferred5_1 = r1;
 ...
 * @returns {string}
 */
export function jqf_version() {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.jqf_version(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('jqf_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
