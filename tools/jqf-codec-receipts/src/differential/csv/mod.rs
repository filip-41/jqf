...
//!
//! The DECLARED table is the CSV row of plan 057's divergence register,
...
const DECLARED: &[Declared] = &[
    ...
    Declared {
        ...
        jqf: Some(true),
        reference: Some(true),
        reason: "jqf publishes a blank line as a zero-field record; the csv crate skips empty lines, so the record products differ",
    },
    Declared {
